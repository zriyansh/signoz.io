...
![SigNoz Architecture Diagram](/img/blog/2021/07/SigNoz_architecture-min.png)SigNoz Architecture with ClickHouse as storage backend
...
![SigNoz Dashboard showing RED metrics](/img/blog/2021/07/signoz_ui-min.png)Capture RED metrics (Rate of requests, Error rate and Duration) and visualize it with SigNoz
...
![Graphite architecture](/img/blog/2021/07/Graphite-architecture-min.png)Graphite Architecture (Source: Graphite documentation)
...
![Graphite APM tool dashboard](/img/blog/2021/07/graphite_dashboard-min.png)Graphite's UI (Source: [Nuxeo](https://doc.nuxeo.com/nxdoc/metrics/))
### Pinpoint
...
![Pinpoint APM tool architecture](/img/blog/2021/07/pinpoint-architecture-min.png)Architecture of Pinpoint (Source: Pinpoint Documentation)
...
![Pinpoint dashboard](/img/blog/2021/07/pinpoint-dashboard-min.png)Pinpoint Dashboard (Source: Pinpoint documentation)
### Prometheus
...
![Prometheus APM tool architecture](/img/blog/2021/07/Prometheus_architecture-min.png)Prometheus Architecture (Source: Prometheus Documentation)
...
![Prometheus Expression Browser](/img/blog/2021/07/prom_exp_browser-min.png)Prometheus Expression Browser![Grafana dashboard visualizing Prometheus metrics](/img/blog/2021/07/prometheus_grafana-min.png)Grafana used for visualization with Prometheus
### Javamelody
...
![Charts shown on JavaMelody dashboard](/img/blog/2021/07/javamelody_ui-min.png)Charts provided by Javamelody APM tool (Source: Javamelody GitHub repo)
### Stagemonitor
...
![Architecture diagram of Scouter APM tool](/img/blog/2021/07/scouter_architecture-min-1.png)Scouter Architecture (Source: Scouter GitHub repo)
...
![Zipkin architecture diagram](/img/blog/2021/07/Zipkin_architecture-min.png)Zipkin architecture (Source: Zipkin website)
...
![Zipkin dashboard showing traces](/img/blog/2021/07/Zipkin_ui-min.png)Zipkin UI (Source: Zipkin's GitHub repo)
...
![Zipkin dependency diagram to show user requests across services](/img/blog/2021/07/zipkin_dependency_diagram-min.png)Zipkin dependency diagram (Source: GitHub repo)
### Jaeger
...
![Architecture diagram of Jaeger APM](/img/blog/2021/07/jaeger_architecture-min.png)Jaeger Architecture (Source: Uber Engineering)
...
![Skywalking dashboard](/img/blog/2021/07/skywalking_ui-min.png)Skywalking dashboard (Source: Skywalking website)
### Elastic APM
...
![Elastic APM architecture diagram](/img/blog/2021/07/elastic_apm_architecture-min.png)Elastic APM architecture (Source: Elastic APM documentation)
With Kibana, you can have visualize your requests and services.
![Service maps on Elastic APM dashboard](/img/blog/2021/07/elasticapm_servicemaps-min.png)Service Maps in Elastic APM (Source: Elastic APM website)
### App Metrics
...
![Grafana charts for visualization of App Metrics](/img/blog/2021/07/app-metrics-dashboard-min.png)App Metrics dashboard using Grafana (Source: App Metrics website)
### Glowroot
...
![Glowroot architecture diagram](/img/blog/2021/07/glowroot-architecture-min.png)Glowroot architecture
