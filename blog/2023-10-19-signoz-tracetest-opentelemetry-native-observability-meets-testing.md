...
[​​SigNoz](https://signoz.io/) is an open-source, OpenTelemetry-native observability tool that helps you monitor your applications and troubleshoot problems. It provides [traces](https://signoz.io/docs/instrumentation/overview/), [metrics](https://signoz.io/docs/userguide/navigate-user-interface/), and [logs](https://signoz.io/docs/userguide/logs/) under a single pane of glass.
...
![architecture](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697716957/Blogposts/signoz-integration/new/Untitled-2023-05-22-1321_m03lvk.png)
_Image 1: Application architecture._
...
![test spec sample](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715804/Blogposts/signoz-integration/new/image_51_ctrfnj.png)
_Image 2: In this example, within the Tracetest UI you can see that test assertions for trace spans succeeded._
...
![tracetest tests triggered and visualized in signoz](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715804/Blogposts/signoz-integration/new/image_52_hqyisz.png)
_Image 3: Traces triggered by Tracetest surfaced in SigNoz._
...
![Image 4: Here you see a trace drilldown of a test in the SigNoz front end.](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715807/Blogposts/signoz-integration/new/image_53_ms9rcw.png)
_Image 4: Here you see a trace drilldown of a test in the SigNoz front end._
...
![Image 5: Selecting SigNoz in the Tracetest settings.](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715806/Blogposts/signoz-integration/new/image_54_ymupdj.png)
_Image 5: Selecting SigNoz in the Tracetest settings._
...
![Image 6: Trace Analyzer in the Tracetest Web UI. Validate the quality of the code instrumentation.](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715808/Blogposts/signoz-integration/new/image_55_mk5mi1.png)
_Image 6: Trace Analyzer in the Tracetest Web UI. Validate the quality of the code instrumentation._
...
![Image 7: Adding assertions to a test in the Tracetest Web UI.](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715808/Blogposts/signoz-integration/new/image_56_rua1fi.png)
_Image 7: Adding assertions to a test in the Tracetest Web UI._
...
![Image 8: Filter “Tracetest trigger” traces.](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715807/Blogposts/signoz-integration/new/image_57_lzugvy.png)
_Image 8: Filter “Tracetest trigger” traces._

The distributed traces chart will be filtered and display performance over time.

![Image 9: Show the results of the filter above. View the chart to see performance and select a distinct trace to drill down.](https://res.cloudinary.com/djwdcmwdz/image/upload/v1697715805/Blogposts/signoz-integration/new/image_58_tlqtqa.png)
_Image 9: Show the results of the filter above. View the chart to see performance and select a distinct trace to drill down._
...
Want to learn more about SigNoz? [Read more here](https://signoz.io/).
